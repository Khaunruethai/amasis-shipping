...
<body>
       ...
       <div class = "font"><p>service/ img<p></div>
       <hr>

 
<!-- ********************************************************************************************** -->
<form action="service_img.php"  method="POST">
        <center>
        <div class ="well">
<div class = "fontt"><p>SERVICE</p></div>
<div class="custom-select" style="width:500px;">
        <select  name ="pro_image15">
...
<div class = "fontt"><p>REEFER SERVICE</p></div>
<div class="custom-select" style="width:500px;">
<select  name ="pro_image20">
    <option value="" >--Select--</option>
<?php
  $sqli = "SELECT * FROM img_logis ";
  $objQuery = mysqli_query($objCon, $sqli);
