...
<form action="updateCON_eng.php"  method="POST">
			   <div class = "fontt"><p> Address</p> </div>
           <textarea id="text73" name="message73" style="height:50px"><?php echo $variable[74];?></textarea><br><br>
           <div class = "fontt"><p> Email</p> </div>
           <textarea id="text74" name="message74" style="height:50px"><?php echo $variable[76];?></textarea><br><br>
