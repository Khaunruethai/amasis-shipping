...
<body>
          ...
          <div class = "font"><p>contact&nbsp;/&nbsp;vn</p></div>
          <hr>
          <div class="container" class="responsive ">
          <form action="updateCON_vn.php"  method="POST">
          <div class = "fontt"><p>ฺAddress</p></div>
           <textarea id="text77" name="message77" style="height:50px"><?php echo $variable1[74];?></textarea><br><br>
           <div class = "fontt"><p>Email</p></div>
           <textarea id="text78" name="message78" style="height:50px"><?php echo $variable1[76];?></textarea><br><br>
					 <div class = "fontt"><p>Phone Number</p></div>
           <textarea id="text79" name="message79" style="height:50px"><?php echo $variable1[78];?></textarea><br><br>
					 <div class = "fontt"><p>Fax</p></div>
           <textarea id="text80" name="message80" style="height:50px"><?php echo $variable1[80];?></textarea><br><br>
