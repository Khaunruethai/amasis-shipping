...
<body>
       ...
       <div class="container" class="responsive ">
          ...
          <textarea type="text" name="message200" style="height:50px"><?php echo $variable[4];?></textarea><br><br>
         <div class = "fontt"><p>service</p></div>
          <textarea type="text1"  name="message201" style="height:50px"><?php echo $variable[5];?></textarea><br><br>
          <div class = "fontt"><p>contact</p></div>
          <textarea  type="text2" name="message202" style="height:50px"><?php echo $variable[6];?></textarea><br><br>
