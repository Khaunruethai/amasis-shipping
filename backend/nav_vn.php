...
<body>
       ...
       <div class="container" class="responsive ">
          ...
          <div class = "fontt"> <p>incoterm</p></div>
          <textarea type="text" name="message1" style="height:50px"><?php echo $variable1[4];?></textarea><br><br>
         <div class = "fontt"><p>service</p></div>
          <textarea type="text1"  name="message2" style="height:50px"><?php echo $variable1[5];?></textarea><br><br>
          <div class = "fontt"><p>contact</p></div>
          <textarea  type="text2" name="message3" style="height:50px"><?php echo $variable1[6];?></textarea><br><br>
          <div class = "fontt"><p>portfolio</p></div>
          <textarea type="text3"  name="message4"style="height:50px"><?php echo $variable1[7];?></textarea><br><br>
